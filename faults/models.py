...
class FaultsClass(models.Model):
    name = models.CharField(max_length=255, verbose_name=u"故障分类")

    def __unicode__(self):
        return self.name

    class Meta:
        db_table = u'faults_class'


class FaultsProject(models.Model):
    name = models.CharField(max_length=255, verbose_name=u"故障项目")

    def __unicode__(self):
        return self.name

    class Meta:
        db_table = u'faults_project'


class FaultsContent(models.Model):
    fault_level_choices = (
        (0, u"P0"),
        (1, u"P1"),
        (2, u"P2"),
    ...
    type = models.ForeignKey(u'FaultsClass', verbose_name=u'故障类型')
    ...
    project = models.ForeignKey(u'FaultsProject', verbose_name=u'影响项目')
